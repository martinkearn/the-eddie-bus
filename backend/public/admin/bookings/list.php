...
try {
    ...
    if ($q !== '') {
        ...
        $searchColumns = [
            ...
            "CASE WHEN bookings.checklist_lights_indicators IS NULL THEN 'not entered' WHEN bookings.checklist_lights_indicators = 1 THEN 'yes' ELSE 'no' END",
            "CASE WHEN bookings.checklist_tyres IS NULL THEN 'not entered' WHEN bookings.checklist_tyres = 1 THEN 'yes' ELSE 'no' END",
            "CASE WHEN bookings.checklist_wheel_nuts IS NULL THEN 'not entered' WHEN bookings.checklist_wheel_nuts = 1 THEN 'yes' ELSE 'no' END",
            "CASE WHEN bookings.checklist_bodywork IS NULL THEN 'not entered' WHEN bookings.checklist_bodywork = 1 THEN 'yes' ELSE 'no' END",
            "CASE WHEN bookings.checklist_mirrors_glass IS NULL THEN 'not entered' WHEN bookings.checklist_mirrors_glass = 1 THEN 'yes' ELSE 'no' END",
            "CASE WHEN bookings.checklist_brakes IS NULL THEN 'not entered' WHEN bookings.checklist_brakes = 1 THEN 'yes' ELSE 'no' END",
            "CASE WHEN bookings.checklist_steering IS NULL THEN 'not entered' WHEN bookings.checklist_steering = 1 THEN 'yes' ELSE 'no' END",
            "CASE WHEN bookings.checklist_wipers_washers IS NULL THEN 'not entered' WHEN bookings.checklist_wipers_washers = 1 THEN 'yes' ELSE 'no' END",
            "CASE WHEN bookings.checklist_dashboard_warning_lights IS NULL THEN 'not entered' WHEN bookings.checklist_dashboard_warning_lights = 1 THEN 'yes' ELSE 'no' END",
            "CASE WHEN bookings.checklist_seats_seatbelts IS NULL THEN 'not entered' WHEN bookings.checklist_seats_seatbelts = 1 THEN 'yes' ELSE 'no' END",
            "CASE WHEN bookings.checklist_emergency_equipment IS NULL THEN 'not entered' WHEN bookings.checklist_emergency_equipment = 1 THEN 'yes' ELSE 'no' END",
            "CASE WHEN bookings.checklist_wheelchair_lifts_restraints IS NULL THEN 'not entered' WHEN bookings.checklist_wheelchair_lifts_restraints = 1 THEN 'yes' ELSE 'no' END",
            "CASE WHEN bookings.checklist_tail_lifts IS NULL THEN 'not entered' WHEN bookings.checklist_tail_lifts = 1 THEN 'yes' ELSE 'no' END",
