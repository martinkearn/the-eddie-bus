...
export const bookingPage = {
  ...
  intro: [
    ...
    'Use the booking request form below to choose an available date and send your journey details. This is our primary way to manage bookings.',
    'If you prefer, you can still book by email or phone.',
  ],
  steps: [
    'Submit the booking form with your preferred date and journey details.',
    'We review your request and check volunteer driver availability.',
    'We contact you to confirm the booking and agree final timings and collection details.',
  ...
  categories: [
    ...
    },
    {
      ...
      items: [
        ...
        { label: 'Droitwich', href: 'https://www.visitdroitwichspa.com/' },
        { label: 'Evesham', href: 'https://www.visitevesham.co.uk/' },
        { label: 'Gloucester Docks', href: 'https://www.gloucesterdocks.me/' },
        { label: 'Hagley', href: 'https://www.townandvillageguide.com/Worcestershire/Hagley.html' },
        ...
        { label: 'Wychbold', href: 'https://www.townandvillageguide.com/Worcestershire/Wychbold.html' },
      ],
    },
    {
