...
export const placesPage = {
  ...
  categories: [
    { title: 'Garden centres', items: ['De Beers, Stourport', 'David’s, Martin Hussingtree', 'Webbs, Wychbold', 'Little Heath Nursery, Lickey End', 'Willowbrook, Catshill', 'Cherry Lane, Harvington', 'Rowberry’s, Chaddesley Corbett', 'Mappleborough Green', 'Webbs, Hagley', 'Barnetts Hill', 'Notcutts, Shirley', 'St Peters, Worcester'] },
    { title: 'Towns and places to explore', items: ['Bridgnorth', 'Bewdley', 'Evesham', 'Worcester', 'Malvern', 'Stourport', 'Stratford', 'Broadway', 'Studley', 'Bromsgrove', 'Gloucester Docks', 'Moreton-in-Marsh', 'Chipping Campden', 'Bourton-on-the-Water', 'Kidderminster', 'Warwick', 'Ironbridge'] },
    { title: 'Museums and heritage attractions', items: ['West Midland Safari Park', 'Thinktank, Birmingham', 'Black Country Living Museum', 'Blists Hill Victorian Village', 'RAF Defford', 'RAF Cosford', 'Severn Valley Railway', 'National Motorcycle Museum, Marston Green', 'British Motor Museum, Gaydon', 'Avoncroft Museum of Historic Buildings'] },
    { title: 'Theatres', items: ['Birmingham Hippodrome', 'Alexandra Theatre, Redditch', 'Norbury Theatre, Droitwich', 'Palace Theatre, Redditch', 'Malvern Theatres'] },
    { title: 'Activities', items: ['Hollywood Bowl', 'Droitwich canal trips'] },
    { title: 'Stately homes and historic sites', items: ['Witley Court, English Heritage', 'Croome Court, National Trust', 'Hanbury Hall, National Trust', 'Harvington Hall', 'Coughton Court, National Trust', 'Broadway Tower'] },
    { title: 'Parks and gardens', items: ['Bodenham Arboretum', 'Arley Arboretum', 'Sanders Park', 'Cannon Hill Park', 'Birmingham Botanical Gardens, Edgbaston', 'Trentham Gardens, Stoke-on-Trent'] },
    { title: 'Retail and shopping destinations', items: ['Kingfisher Centre, Redditch', 'Evesham Country Park', 'Blackpole, Worcester', 'Hatton Country Park, Warwick', 'Jinney Ring', 'Merry Hill', 'Longbridge', 'Touchwood, Solihull'] },
    { title: 'Zoos, wildlife and animal attractions', items: ['Dudley Zoo', 'National SEA LIFE Centre, Birmingham', 'Slimbridge Wetland Centre', 'Cotswold Wildlife Park, Burford', 'West Midland Safari Park', 'Twycross Zoo', 'Stratford Butterfly Farm', 'Attwell Farm Park, Redditch', 'Birmingham Wildlife Conservation Park, Cannon Hill Park'] },
  ],
}
